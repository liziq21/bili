...
class MediaHistoryDao extends DatabaseAccessor<AppDatabase>
  ...
  // 获取带媒体信息的历史记录
  Future<List<({MediaHistoryEntity history, MediaEntity media})>>
  getHistoryWithMedia({int limit = 20, int offset = 0}) {
    final query =
        select(mediaHistory).join([
