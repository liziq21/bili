...
class MockNetworkVideoDataSource implements NetworkVideoDataSource {
  final Map<String, dynamic> videoDetailJson;
  final Map<String, dynamic> videoRelationJson;
  final List<dynamic> relatedVideosJson;
  final Map<String, dynamic> replyListJson;

  MockNetworkVideoDataSource({
    required this.videoDetailJson,
    required this.videoRelationJson,
    required this.relatedVideosJson,
    required this.replyListJson,
  });
