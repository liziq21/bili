...
void main() {
  group('YouTube Package Initializer Tests', () {
    ...
    test('Search sort and filter options localize correctly in Chinese (zh) and English (en)', () {
      ...
      expect(YoutubeSearchSort.relevance.labelWithL10n(en), equals('Relevance'));

      expect(YoutubeSearchSort.uploadDate.labelWithL10n(zh), equals('上传时间'));
      expect(YoutubeSearchSort.uploadDate.labelWithL10n(en), equals('Upload date'));

      expect(YoutubeSearchSort.viewCount.labelWithL10n(zh), equals('播放量'));
      expect(YoutubeSearchSort.viewCount.labelWithL10n(en), equals('View count'));
      ...
      expect(YoutubeUploadDateFilterOption.today.labelWithL10n(zh), equals('今天'));
      expect(YoutubeUploadDateFilterOption.today.labelWithL10n(en), equals('Today'));

      expect(YoutubeDurationFilterOption.under4Minutes.labelWithL10n(zh), equals('4分钟以下'));
      expect(YoutubeDurationFilterOption.under4Minutes.labelWithL10n(en), equals('Under 4 minutes'));
