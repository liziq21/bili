...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final ExtractorDao extractorDao = ExtractorDao(this as AppDatabase);
...
class $$ExtractorTableFilterComposer
    extends Composer<_$AppDatabase, $ExtractorTable> {
...
class $$ExtractorTableTableManager
    extends
        RootTableManager<
          ...
          (
            ExtractorEntity,
            BaseReferences<_$AppDatabase, $ExtractorTable, ExtractorEntity>,
          ),
          ExtractorEntity,
          PrefetchHooks Function()
        > {
  $$ExtractorTableTableManager(_$AppDatabase db, $ExtractorTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
