...
class _NetworkSearchResultWrapper implements NetworkSearchResultWrapper {
  const _NetworkSearchResultWrapper({required final  List<NetworkArticleSearchResult> article, required final  List<NetworkBiliUserSearchResult> biliUser, required final  List<NetworkMediaBangumiSearchResult> mediaBangumi, required final  List<NetworkMediaFtSearchResult> mediaFt, required final  List<NetworkLiveRoomSearchResult> liveRoom, required final  List<NetworkLiveUserSearchResult> liveUser, required final  List<NetworkVideoSearchResult> video}): _article = article,_biliUser = biliUser,_mediaBangumi = mediaBangumi,_mediaFt = mediaFt,_liveRoom = liveRoom,_liveUser = liveUser,_video = video;
  

 final  List<NetworkArticleSearchResult> _article;
@override List<NetworkArticleSearchResult> get article {
...
@override List<NetworkBiliUserSearchResult> get biliUser {
...
@override List<NetworkMediaBangumiSearchResult> get mediaBangumi {
...
@override List<NetworkMediaFtSearchResult> get mediaFt {
...
@override List<NetworkLiveRoomSearchResult> get liveRoom {
...
@override List<NetworkLiveUserSearchResult> get liveUser {
...
@override List<NetworkVideoSearchResult> get video {
