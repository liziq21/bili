...
class _NetworkSearchSuggest implements NetworkSearchSuggest {
  const _NetworkSearchSuggest(final  List<NetworkSearchSuggestItem>? tag): _tag = tag;
...
freezed == tag ? _self._tag : tag // ignore: cast_nullable_to_non_nullable
as List<NetworkSearchSuggestItem>?,
  ));
}
...
class _NetworkSearchSuggestItem implements NetworkSearchSuggestItem {
  const _NetworkSearchSuggestItem(this.term, this.name);
