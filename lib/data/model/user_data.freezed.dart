...
mixin _$UserData {
 ...
 ServiceSource get serviceSource; ThemeConfig get themeConfig; bool get useDynamicColor;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,serviceSource,themeConfig,useDynamicColor);

@override
String toString() {
  return 'UserData(serviceSource: $serviceSource, themeConfig: $themeConfig, useDynamicColor: $useDynamicColor)';
}
...
@useResult
$Res call({
 ServiceSource serviceSource, ThemeConfig themeConfig, bool useDynamicColor
});
...
/// Create a copy of UserData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? serviceSource = null,Object? themeConfig = null,Object? useDynamicColor = null,}) {
  return _then(_self.copyWith(
serviceSource: null == serviceSource ? _self.serviceSource : serviceSource // ignore: cast_nullable_to_non_nullable
as ServiceSource,themeConfig: null == themeConfig ? _self.themeConfig : themeConfig // ignore: cast_nullable_to_non_nullable
...
/// Create a copy of UserData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? serviceSource = null,Object? themeConfig = null,Object? useDynamicColor = null,}) {
