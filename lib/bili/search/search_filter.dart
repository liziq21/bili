import 'pack/model/data/filter_group.dart'
...
class BiliVideoDurationFilter implements FilterGroup<VideoDurationFilterOption> {
  const BiliVideoDurationFilter(
    super.label = 'BiliVideoDurationFilter',
    super.options = VideoDurationFilterOption.values,
