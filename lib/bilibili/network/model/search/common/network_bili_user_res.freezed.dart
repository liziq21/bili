...
class _NetworkBiliUserRes implements NetworkBiliUserRes {
  const _NetworkBiliUserRes({required this.aid, required this.bvid, required this.title, required this.pubdate, required this.arcurl, required this.pic, required this.play, required this.dm, required this.coin, required this.fav, required this.desc, required this.duration, required this.isPay, required this.isUnionVideo, required this.isChargeVideo, required this.vt, required this.enableVt, required this.vtDisplay});
